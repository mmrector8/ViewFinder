      ...
      <div className="spot-show-grid-container">
        <div className="upvoted-photos">
          <div
            className={
              spot.photos[0]
                ? "most-upvoted-photo-container"
                : "no-photos-yet-container"
            }
          >
            {spot.photos[0] ? (
              <img
              ...
              <p className="no-photos-yet">
                {currentUser
                  ? "No photos yet! Click the camera button in the top right corner to add one!"
                  : "No photos yet! Please login and click the camera button in the top right corner to add one!"}
              </p>
            )}
          </div>
          <div
            className={
              spot.photos[0] ? "top-upvoted-photos" : "no-display-photos"
            }
          >
            ...
            <div className="spot-info-item">
              ...
              <div className="spot-info-items conditions-info-items">
                {getConditions(photos)?.map((item, i) => (
                  <p key={i} className="condition-info-item">
                    {item}
                  </p>
                ))}
              </div>
